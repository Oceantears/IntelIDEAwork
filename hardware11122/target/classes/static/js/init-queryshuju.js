$(function(){
    ...
    var KEYID = window.location.search.substring(7);
        ...
        $.ajax({
            ...
            success : function (data){
                ...
                /*
                                    ...
                                    imageId2.empty();
                                    var imageId3=$("#imageId3");
                                    imageId3.empty();
                                    var imageId4=$("#imageId4");
                                    imageId4.empty();
                                    var imageId5=$("#imageId5");
                                    imageId5.empty();
                                    var imageId6=$("#imageId6");
                                    imageId6.empty();
                                    var imageId7=$("#imageId7");
                                    imageId7.empty();
                                    var imageId8=$("#imageId8");
                                    imageId8.empty();
                                    var imageId9=$("#imageId9");
                                    imageId9.empty();
                                    var imageId10=$("#imageId10");
                                    imageId10.empty();
                                    var imageId11=$("#imageId11");
                                    imageId11.empty();
                                    var imageId12=$("#imageId12");
                                    imageId12.empty();*/
