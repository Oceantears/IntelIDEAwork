...
public class AtmosphericHumidityInterface {
    public static List<String> dop(String z, QxpreMapper qxpreMapper) {
        ...
        for (int i = 0; i < qxpres.size(); i++) {
            try {
                ...
                RequestBody body = RequestBody.create(mediaType, "{ \"apiCode\": \"GetLastSingleData\", \"timestamp\": null, \"queries\": [{ \"metric\": \"atmosphericHumidity\", \"tags\": { \"SN\": \"" + z + "\" } }] }");
