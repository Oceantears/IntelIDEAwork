                ...
                function() {
                    ...
                    var tab=table.render({
                        ...
                        ,cols : [ [ /*{
                            ...
                            ,{field:'product_id', title:'产品id',hide:true}
                            ,{field:'project_id', title:'项目id',hide:true}
                            ,{field:'proj_constitute', title:'组成对象'}
                            ,{field:'proj_classes', title:'组成类别'}
                            ,{field:'proj_price', title:'组成对象金额'}
                            ,{field:'percent', title:'所占比例'}
