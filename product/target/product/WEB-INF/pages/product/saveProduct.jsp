...
<body>
<form class="layui-form" action="/product/saveProduct" method="post">
    ...
    <div class="layui-form-item" style="margin-top: 10px">
        ...
        <div class="layui-input-block">
            <input style="width: 190px;" type="text" name="product_name" required
    ...
    <div class="layui-form-item" style="margin-top: 10px">
        ...
        <div class="layui-input-block" style="width:190px; margin-left: 130px">
            <input style="width: 190px;" type="text" name="unit" required
                   lay-verify="required" placeholder="请输入计量单位" autocomplete="off"
                   class="layui-input" >
        </div>
    </div>
    <div class="layui-form-item" style="margin-top: 10px">
        ...
        <div class="layui-input-block">
            <input style="width: 190px;" type="text" name="unit_price" required
    ...
    <div class="layui-form-item" style="margin-top: 10px">
        ...
        <div class="layui-input-block">
            <input style="width: 190px;" type="text" name="introduce" required
    ...
    <div class="layui-form-item" style="margin-top: 10px">
        ...
        <div class="layui-input-block">
            <input style="width: 190px;" type="text" name="image_path" required
                   lay-verify="required" placeholder="" autocomplete="off"
                   class="layui-input" >
        </div>
    </div>
    <div class="layui-form-item" style="margin-top: 10px">
        ...
        <div class="layui-input-block">
            <input style="width: 190px;" type="text" name="product_gross" required
                   lay-verify="required" placeholder="请输入产品总价" autocomplete="off"
                   class="layui-input" >
        </div>
    </div>
    <div class="layui-form-item" style="margin-top: 10px">
        ...
        <div class="layui-input-block">
            <input style="width: 190px;" type="text" name="specification" required
                   lay-verify="required" placeholder="请输入产品规格" autocomplete="off"
                   class="layui-input" >
        </div>
    </div>
