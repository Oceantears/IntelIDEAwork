...
<body class="hold-transition skin-blue sidebar-mini">
						...
						<ul class="pagination">
							...
							<li><a href="javascript:gotoPage(${pageInfo.prePage})">上一页</a></li>
							 <c:forEach begin="${pageInfo.navigateFirstPage}" end="${pageInfo.navigateLastPage}" var="i">
								...
								<li class="${pageInfo.pageNum==i?'active':''}"><a href="javascript:gotoPage(${i})">${i}</a></li>
							 </c:forEach>
	...
	<script type="text/javascript">
        ...
        function gotoPage(currPage){
            ...
            location.href="${pageContext.request.contextPath}/product/findAll3?currPage="+currPage+"&pageSize="+pageSize;
        }
