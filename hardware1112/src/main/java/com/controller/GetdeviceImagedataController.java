...
public class GetdeviceImagedataController {
    ...
    public static void dop(GetdeviceImagedata get, GetdeviceImagedataMapper getdeviceImagedataMapper, CameraMapper cameraMapper, AccesstokenMapper accesstokenMapper) throws IOException {
        ...
        for (String s : arry) {
            ...
            List<String> aa = PictureInterfaces.dop(s, accesstokenMapper);
            for (String a : aa) {
                //接受json data数组
                ...
                if (jb.containsKey("data")) {
                    ...
                    //JsonArray userArray = new JsonParser().parse(aa).getAsJsonObject().get("data").getAsJsonArray();
                    ...
                    String path ="D:\\download\\" + s + "\\" + for1 + "\\"+for2+".jpg";
                    ...
                    Date dates = new Date(System.currentTimeMillis()+28800000);
