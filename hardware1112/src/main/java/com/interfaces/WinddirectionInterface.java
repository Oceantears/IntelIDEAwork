...
public class WinddirectionInterface {
    public static List<String> dop(String z, QxpreMapper qxpreMapper) {
        ...
        for (int i = 0; i < qxpres.size(); i++) {
            ...
            RequestBody body = RequestBody.create(mediaType, "{ \"apiCode\": \"GetLastSingleData\", \"timestamp\": null, \"queries\": [{ \"metric\": \"windDirection\", \"tags\": { \"SN\": \"" + z + "\" } }] }");
