...
public class TemperatureInterface {
    ...
    public static List<String> dop(String z, QxpreMapper qxpreMapper) throws IOException {
        ...
        //RequestBody body = RequestBody.create(mediaType, "{ \"apiCode\": \"GetHisSingleData\", \"start\":"+sss+", \"end\": "+ss+", \"queries\": [{ \"downsample\": \"15mc-avg-null\", \"metric\": \"atmosphericTemperature\", \"limit\":0, \"offset\": 0, \"dpValue\":null, \"tags\": { \"SN\": \""+z+"\"\r\n}\r\n}]\r\n}");
        RequestBody body = RequestBody.create(mediaType, "{ \"apiCode\": \"GetLastSingleData\", \"timestamp\": null, \"queries\": [{ \"metric\": \"atmosphericTemperature\", \"tags\": { \"SN\": \""+z+"\" } }] }");
