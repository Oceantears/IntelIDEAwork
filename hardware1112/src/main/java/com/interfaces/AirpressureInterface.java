...
public class AirpressureInterface {
    public static List<String> dop(String z, QxpreMapper qxpreMapper) throws IOException {
        ...
        for ( int i = 0; i < qxpres.size(); i++ ) {
            ...
            //RequestBody body = RequestBody.create(mediaType, "{ \"apiCode\": \"GetHisSingleData\", \"start\":" + sss + ", \"end\": " + ss + ", \"queries\": [{ \"downsample\": \"15mc-avg-null\", \"metric\": \"airPressure\", \"limit\":0, \"offset\": 0, \"dpValue\":null, \"tags\": { \"SN\": \"" + z + "\"\r\n}\r\n}]\r\n}");
            RequestBody body = RequestBody.create(mediaType, "{ \"apiCode\": \"GetLastSingleData\", \"timestamp\": null, \"queries\": [{ \"metric\": \"airPressure\", \"tags\": { \"SN\": \""+z+"\" } }] }");
